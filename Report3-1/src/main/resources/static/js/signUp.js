document.addEventListener("DOMContentLoaded", function() {
  ...
  const NameInputs = document.querySelector(".IdPw .NameInput");
  const DateBirthInput = document.querySelector(".IdPw .DateBirthInput");
  const PhoneInput = document.querySelector(".IdPw .PhoneInput");
  const EmailInput = document.querySelector(".IdPw .EmailInput");
  const errorbox = document.querySelector("#email_errorbox");
    ...
    function IdPwSubmit(event){
      ...
      Confirm(Pass,ConfirmPass);  //비밀번호 확인의 값
